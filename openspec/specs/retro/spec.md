...
Retrospective analysis of tool usage in the current session — identify unnecessary approval prompts, missed tooling, skill candidate patterns, and suggest improvements.
